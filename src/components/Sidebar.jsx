...
export default function Sidebar() {
  return (
    <aside className="w-64 shrink-0 bg-brand-800 text-white flex flex-col h-screen sticky top-0">
      {/* Brand */}
          ...
          >
            {({ isActive }) => (
              <>
                <item.icon
                  size={18}
                  className={cx(item.live && !isActive && 'text-red-400')}
                />
